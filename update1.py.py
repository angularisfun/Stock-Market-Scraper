...
list_stock_symbol = ['apple' , 'TPE:2354' , 'amzn' , 'NYSE:HPQ' , 'NASDAQ:MSFT' , 'NASDAQ:MSFT' , 'NASDAQ:GOOGL' , 'fb' , 'NYSE:SNE' , 'NASDAQ:DELL' , 'NASDAQ:INTC']

url_basic = "https://www.google.com/finance?q="
#url_input = input("Enter the stock you wish to see:")

for url_input in list_stock_symbol:
